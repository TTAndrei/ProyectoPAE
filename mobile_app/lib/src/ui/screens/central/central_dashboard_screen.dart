...
class CentralDashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final activeDriversCount = drivers.where((d) => d.lat != null && d.lng != null).length;
    final completedOrdersCount = orders.where((o) => o.status == 'completed').length;
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 4),
                  Text('Resumen operativo de la flota en tiempo real', style: TextStyle(color: Colors.grey)),
                ],
              ),
              Wrap(
                spacing: 12,
          ...
          // Lower Section: Distribution and Performance Card
          Expanded(
            child: Row(
